...
static void write_8(uint8_t bytes)
{
  LL_GPIO_WriteOutputPort(TFT_DATA, bytes);
}
...
//  for (int i=0;i<8;i++) {
//    LL_GPIO_SetPinMode(TFT_DATA, 1<<i, LL_GPIO_MODE_OUTPUT);
//  }
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D0, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D1, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D2, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D3, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D4, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D5, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D6, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D7, LL_GPIO_MODE_OUTPUT);
...
//  for (int i=0;i<8;i++) {
//    LL_GPIO_SetPinMode(TFT_DATA, 1<<i, LL_GPIO_MODE_INPUT);
//  }
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D0, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D1, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D2, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D3, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D4, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D5, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D6, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinMode(TFT_DATA, TFT_D7, LL_GPIO_MODE_INPUT);

}

/*
void MCUFRIEND_kbv::WriteCmd(uint16_t c) {
  CS_ACTIVE;
  CD_COMMAND;
  RD_IDLE;
  WR_IDLE;
...
void MCUFRIEND_kbv::writeDataByte(uint8_t c) {
  CS_ACTIVE;
  CD_DATA;
  RD_IDLE;
  WR_IDLE;
...
void MCUFRIEND_kbv::writeDataWord(uint16_t c) {
  CS_ACTIVE;
  CD_DATA;
  RD_IDLE;
  WR_IDLE;
...
void MCUFRIEND_kbv::println(const char * ptr)
{
	int i, len;
...
void MCUFRIEND_kbv::printdec(int var)
{
	char tmp[16];
	int len;
...
void MCUFRIEND_kbv::print(const char * ptr)
{
	int i, len;
